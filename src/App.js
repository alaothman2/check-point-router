...
function App() {
  const movies = [
    {
      ...
      rating: 9.3,
      trailer: <link rel="stylesheet" href="https://www.youtube.com/watch?v=yjRHZEUamCc" />
    },
    {
      id: 2,
      title: "The Godfather",
      ...
      rating: 9.2,
      trailer: <link rel="stylesheet" href="https://www.youtube.com/watch?v=UaVTIH8mujA" />
    },
    {
      id: 3,
      ...
      rating: 9.0,
      trailer: <link rel="stylesheet" href="https://www.youtube.com/watch?v=32RAq6JzY-w" />
    },
  ];
  ...
  return (
    ...
    <div className="App">
      ...
      <Routes>
          <Route path="card" element={<Card movie={movie}/>} />
        <Route path="/" element={<MovieList  movie={movie}/>} />
          <Route path="filter" element={<Filter movie={movie}  />} />
          <Route path="addmovie" element={<MovieCard movie={movie}  setMovie={setMovie} />}></Route>
      </Routes>
    </div></>
